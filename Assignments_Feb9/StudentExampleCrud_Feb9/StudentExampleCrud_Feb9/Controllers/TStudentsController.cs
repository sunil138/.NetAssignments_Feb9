...
using StudentExampleCrud_Feb9.Models;

namespace StudentExampleCrud_Feb9.Controllers
{
    public class TStudentsController : Controller
    {
        private readonly StudentContext _context;

        public TStudentsController(StudentContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("StudentId,StudentName,Address,Age")] TStudent tStudent)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,StudentName,Address,Age")] TStudent tStudent)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'StudentContext.TStudents'  is null.");
            }
            var tStudent = await _context.TStudents.FindAsync(id);
            if (tStudent != null)
            {
