...
using SunilStudent_Feb9.Models;

namespace SunilStudent_Feb9.Controllers
{
    public class StudentDetailsController : Controller
    {
        ...
        {
            var studentContext = _context.StudentDetails.Include(s => s.Course);
        ...
        {
            ViewData["CourseId"] = new SelectList(_context.CourseDetails, "CourseId", "CourseId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("StudentId,StudentName,StudentAddress,StudentAge,CourseId")] StudentDetail studentDetail)
        {
            ...
            ViewData["CourseId"] = new SelectList(_context.CourseDetails, "CourseId", "CourseId", studentDetail.CourseId);
            return View(studentDetail);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,StudentName,StudentAddress,StudentAge,CourseId")] StudentDetail studentDetail)
        {
